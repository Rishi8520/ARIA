...
static StaticTask_t imu_thread_memory;
                ...
                static uint8_t imu_thread_stack[8192] BSP_PLACE_IN_SECTION(BSP_UNINIT_SECTION_PREFIX ".stack.thread") BSP_ALIGN_VARIABLE(BSP_STACK_ALIGNMENT);
                #else
static uint8_t imu_thread_stack[8192] BSP_PLACE_IN_SECTION(BSP_UNINIT_SECTION_PREFIX ".stack.imu_thread") BSP_ALIGN_VARIABLE(BSP_STACK_ALIGNMENT);
#endif
#endif
...
void imu_thread_create(void)
{
    ...
    imu_thread = xTaskCreateStatic (
                    ...
                    #endif
                                    imu_thread_func,
                                    (const char*) "imu_thread", 8192 / 4, // In words, not bytes
