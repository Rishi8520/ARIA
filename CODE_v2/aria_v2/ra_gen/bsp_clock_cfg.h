...
#define BSP_CFG_PL2ODIVQ (BSP_CLOCKS_PLL_DIV_9) /* PLL2Q Div /9 */
...
#define BSP_CFG_SCICLK_SOURCE (BSP_CLOCKS_SOURCE_CLOCK_PLL1Q) /* SCICLK Src: PLL1Q */
...
#define BSP_CFG_SPICLK_DIV (BSP_CLOCKS_SPI_CLOCK_DIV_6) /* SPICLK Div /6 */
...
#define BSP_CFG_UCK_DIV (BSP_CLOCKS_USB_CLOCK_DIV_8) /* UCK Div /8 */
